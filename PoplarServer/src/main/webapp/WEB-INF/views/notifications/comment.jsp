		...
		<div class="row">
			<div class="span4">
				<div class="ui vertical menu">
				  <a class="active teal item" href='<c:url value="/notifications/comment"/>' >
				  	评论
				  ...
				  <div class="ui tab  active" data-tab="notread">
						<div class="ui relaxed list">
							<c:forEach items="${notis }" var="notification" begin="0" end="9">
							  <c:if test="${notification.notify_type eq dic.notify_type_comment }">
								  <div class="item">
							  ...
							  <c:if test="${notification.notify_type eq dic.notify_type_comment_reply }">
								  <div class="item">
								    <img class="ui avatar image" src="<c:url value="${img_base_url }${notification.notifier_avatar }" />">
								    <div class="content">
								      <a class="header" href="<c:url value="/user/${notification.notifier }" /> ">${notification.notifier_name }</a>
