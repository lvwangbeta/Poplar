    ...
    return(
      <View style={styles.container}>
        <View style={styles.followingBox}>
            <View>
              <Image source={require('../imgs/avatar.jpg')} style={styles.avatar}/>
            </View>
            <View style={styles.name}><Text style={{fontSize:16}}>不过期的凤梨罐头</Text></View>
            <TouchableOpacity style={styles.unFollowBtn}><Text style={{color: '#FBBD08', fontWeight: 'normal'}}>+关注</Text></TouchableOpacity>
        </View>
        <View style={styles.followingBox}>
          <View>
            <Image source={require('../imgs/avatar2.jpg')} style={styles.avatar}/>
          </View>
            <View style={styles.name}><Text style={{fontSize:16}}>哆啦B梦</Text></View>
        ...
        <View style={styles.followingBox}>
          <View>
            ...
            <View style={styles.name}><Text style={{fontSize:16}}>蜡笔小芯</Text></View>
            <TouchableOpacity style={styles.followBtn}><Text style={{color: 'white', fontWeight: '600'}}>已关注</Text></TouchableOpacity>
        </View>
      </View>
    );
